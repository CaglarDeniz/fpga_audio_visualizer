...
module lab62_soc_mm_interconnect_0 (
		...
		output wire [3:0]  irq_timer_s1_address,                           //                             irq_timer_s1.address
		output wire        irq_timer_s1_write,                             //                                         .write
		input  wire [15:0] irq_timer_s1_readdata,                          //                                         .readdata
		output wire [15:0] irq_timer_s1_writedata,                         //                                         .writedata
		output wire        irq_timer_s1_chipselect,                        //                                         .chipselect
	...
	wire  [106:0] button_s1_agent_rf_source_data;                                                     // button_s1_agent:rf_source_data -> button_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] button_s1_agent_rsp_fifo_out_data;                                                  // button_s1_agent_rsp_fifo:out_data -> button_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> button_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // button_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [15:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> button_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> button_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> button_s1_agent:cp_endofpacket
	...
	wire   [31:0] irq_timer_s1_agent_m0_readdata;                                                     // irq_timer_s1_translator:uav_readdata -> irq_timer_s1_agent:m0_readdata
	wire          irq_timer_s1_agent_m0_waitrequest;                                                  // irq_timer_s1_translator:uav_waitrequest -> irq_timer_s1_agent:m0_waitrequest
	wire          irq_timer_s1_agent_m0_debugaccess;                                                  // irq_timer_s1_agent:m0_debugaccess -> irq_timer_s1_translator:uav_debugaccess
	wire   [27:0] irq_timer_s1_agent_m0_address;                                                      // irq_timer_s1_agent:m0_address -> irq_timer_s1_translator:uav_address
	wire    [3:0] irq_timer_s1_agent_m0_byteenable;                                                   // irq_timer_s1_agent:m0_byteenable -> irq_timer_s1_translator:uav_byteenable
	wire          irq_timer_s1_agent_m0_read;                                                         // irq_timer_s1_agent:m0_read -> irq_timer_s1_translator:uav_read
	wire          irq_timer_s1_agent_m0_readdatavalid;                                                // irq_timer_s1_translator:uav_readdatavalid -> irq_timer_s1_agent:m0_readdatavalid
	wire          irq_timer_s1_agent_m0_lock;                                                         // irq_timer_s1_agent:m0_lock -> irq_timer_s1_translator:uav_lock
	wire   [31:0] irq_timer_s1_agent_m0_writedata;                                                    // irq_timer_s1_agent:m0_writedata -> irq_timer_s1_translator:uav_writedata
	wire          irq_timer_s1_agent_m0_write;                                                        // irq_timer_s1_agent:m0_write -> irq_timer_s1_translator:uav_write
	wire    [2:0] irq_timer_s1_agent_m0_burstcount;                                                   // irq_timer_s1_agent:m0_burstcount -> irq_timer_s1_translator:uav_burstcount
	wire          irq_timer_s1_agent_rf_source_valid;                                                 // irq_timer_s1_agent:rf_source_valid -> irq_timer_s1_agent_rsp_fifo:in_valid
	wire  [106:0] irq_timer_s1_agent_rf_source_data;                                                  // irq_timer_s1_agent:rf_source_data -> irq_timer_s1_agent_rsp_fifo:in_data
	wire          irq_timer_s1_agent_rf_source_ready;                                                 // irq_timer_s1_agent_rsp_fifo:in_ready -> irq_timer_s1_agent:rf_source_ready
	wire          irq_timer_s1_agent_rf_source_startofpacket;                                         // irq_timer_s1_agent:rf_source_startofpacket -> irq_timer_s1_agent_rsp_fifo:in_startofpacket
	wire          irq_timer_s1_agent_rf_source_endofpacket;                                           // irq_timer_s1_agent:rf_source_endofpacket -> irq_timer_s1_agent_rsp_fifo:in_endofpacket
	wire          irq_timer_s1_agent_rsp_fifo_out_valid;                                              // irq_timer_s1_agent_rsp_fifo:out_valid -> irq_timer_s1_agent:rf_sink_valid
	wire  [106:0] irq_timer_s1_agent_rsp_fifo_out_data;                                               // irq_timer_s1_agent_rsp_fifo:out_data -> irq_timer_s1_agent:rf_sink_data
	wire          irq_timer_s1_agent_rsp_fifo_out_ready;                                              // irq_timer_s1_agent:rf_sink_ready -> irq_timer_s1_agent_rsp_fifo:out_ready
	wire          irq_timer_s1_agent_rsp_fifo_out_startofpacket;                                      // irq_timer_s1_agent_rsp_fifo:out_startofpacket -> irq_timer_s1_agent:rf_sink_startofpacket
	wire          irq_timer_s1_agent_rsp_fifo_out_endofpacket;                                        // irq_timer_s1_agent_rsp_fifo:out_endofpacket -> irq_timer_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> irq_timer_s1_agent:cp_valid
	wire  [105:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> irq_timer_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // irq_timer_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [15:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> irq_timer_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> irq_timer_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> irq_timer_s1_agent:cp_endofpacket
	...
	wire          button_s1_agent_rp_valid;                                                           // button_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_008:sink_data
	wire          button_s1_agent_rp_ready;                                                           // router_008:sink_ready -> button_s1_agent:rp_ready
	wire          button_s1_agent_rp_startofpacket;                                                   // button_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          button_s1_agent_rp_endofpacket;                                                     // button_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          irq_timer_s1_agent_rp_valid;                                                        // irq_timer_s1_agent:rp_valid -> router_016:sink_valid
	wire  [105:0] irq_timer_s1_agent_rp_data;                                                         // irq_timer_s1_agent:rp_data -> router_016:sink_data
	wire          irq_timer_s1_agent_rp_ready;                                                        // router_016:sink_ready -> irq_timer_s1_agent:rp_ready
	wire          irq_timer_s1_agent_rp_startofpacket;                                                // irq_timer_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          irq_timer_s1_agent_rp_endofpacket;                                                  // irq_timer_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire          irq_timer_s1_agent_rdata_fifo_src_valid;                                            // irq_timer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] irq_timer_s1_agent_rdata_fifo_src_data;                                             // irq_timer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          irq_timer_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_014:in_0_ready -> irq_timer_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> irq_timer_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> irq_timer_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // irq_timer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> irq_timer_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) irq_timer_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (irq_timer_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (irq_timer_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (irq_timer_s1_agent_m0_read),                     //                         .read
		.uav_write              (irq_timer_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (irq_timer_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (irq_timer_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (irq_timer_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (irq_timer_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (irq_timer_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (irq_timer_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (irq_timer_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (irq_timer_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (irq_timer_s1_write),                             //                         .write
		.av_readdata            (irq_timer_s1_readdata),                          //                         .readdata
		.av_writedata           (irq_timer_s1_writedata),                         //                         .writedata
		.av_chipselect          (irq_timer_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (irq_timer_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (irq_timer_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (irq_timer_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (irq_timer_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (irq_timer_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (irq_timer_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (irq_timer_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (irq_timer_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (irq_timer_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (irq_timer_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (irq_timer_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (irq_timer_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (irq_timer_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (irq_timer_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (irq_timer_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (irq_timer_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (irq_timer_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (irq_timer_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (irq_timer_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (irq_timer_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (irq_timer_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (irq_timer_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (irq_timer_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (irq_timer_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (irq_timer_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (irq_timer_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_014_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_014_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_014_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_014_out_0_error),              //                .error
		.rdata_fifo_src_ready    (irq_timer_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (irq_timer_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (irq_timer_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) irq_timer_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (irq_timer_s1_agent_rf_source_data),              //        in.data
		.in_valid          (irq_timer_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (irq_timer_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (irq_timer_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (irq_timer_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (irq_timer_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (irq_timer_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (irq_timer_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (irq_timer_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (irq_timer_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	lab62_soc_mm_interconnect_0_router_002 router_016 (
		.sink_ready         (irq_timer_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (irq_timer_s1_agent_rp_valid),                    //          .valid
		.sink_data          (irq_timer_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (irq_timer_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (irq_timer_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (irq_timer_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (irq_timer_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (irq_timer_s1_agent_rdata_fifo_src_ready),        //         .ready
