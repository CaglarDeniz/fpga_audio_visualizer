...
module lab62_soc_mm_interconnect_0 (
	...
	wire   [14:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> i2c_0_csr_agent:cp_channel
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> irq_timer_s1_agent:cp_valid
	wire  [105:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> irq_timer_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // irq_timer_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [14:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> irq_timer_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> irq_timer_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> irq_timer_s1_agent:cp_endofpacket
	...
	wire          irq_timer_s1_agent_rp_valid;                                                        // irq_timer_s1_agent:rp_valid -> router_015:sink_valid
	wire  [105:0] irq_timer_s1_agent_rp_data;                                                         // irq_timer_s1_agent:rp_data -> router_015:sink_data
	wire          irq_timer_s1_agent_rp_ready;                                                        // router_015:sink_ready -> irq_timer_s1_agent:rp_ready
	wire          irq_timer_s1_agent_rp_startofpacket;                                                // irq_timer_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          irq_timer_s1_agent_rp_endofpacket;                                                  // irq_timer_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          irq_timer_s1_agent_rdata_fifo_src_valid;                                            // irq_timer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] irq_timer_s1_agent_rdata_fifo_src_data;                                             // irq_timer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          irq_timer_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_013:in_0_ready -> irq_timer_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> irq_timer_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> irq_timer_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // irq_timer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> irq_timer_s1_agent:rdata_fifo_sink_error
